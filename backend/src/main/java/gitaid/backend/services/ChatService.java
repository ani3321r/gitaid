...
import gitaid.backend.dto.ChatMessageResponse;
import gitaid.backend.dto.ChatSessionResponse;
import gitaid.backend.dto.CreateChatSessionRequest;
import gitaid.backend.entity.ChatMessage;
import gitaid.backend.entity.ChatSession;
import gitaid.backend.entity.IndexStatus;
import gitaid.backend.entity.MessageRole;
import gitaid.backend.entity.Repository;
import gitaid.backend.exceptions.BadRequestException;
import gitaid.backend.exceptions.NotFoundException;
import gitaid.backend.repository.ChatMessageRepository;
import gitaid.backend.repository.ChatSessionRepository;
import gitaid.backend.services.ai.ChatPromptBuilder;
import gitaid.backend.services.ai.ChatStreamHandler;
import gitaid.backend.services.ai.CitationMapper;
import gitaid.backend.services.ai.CodeContextRetriver;
...
public class ChatService {
    ...
    private final CodeContextRetriver codeContextRetriever;
